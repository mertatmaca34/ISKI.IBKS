...
namespace ISKI.IBKS.Presentation.WinForms.Features.SettingsPage.MailSettings.View
{
    partial class MailServerSettingsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            label7.Location = new Point(244, 21);
            label7.Name = "label7";
            ...
            label8.Location = new Point(222, 17);
            label8.Name = "label8";
            ...
            TextBoxFromName.PlaceholderText = "İBKS Alarm";
            ...
            titleBarControl1.TitleBarText = "MAIL SUNUCUSU AYARLARI";
            // 
            // tableLayoutPanel6
            // 
