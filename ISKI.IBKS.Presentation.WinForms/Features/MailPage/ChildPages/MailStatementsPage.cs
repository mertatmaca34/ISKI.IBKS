    ...
    public partial class MailStatementsPage : UserControl
    {
        ...
        private void ApplyFilter()
        {
            ...
            DataGridViewAlarms.DataSource = filtered.Select(a => new AlarmDisplayModel
            {
                ...
                Cooldown = GetCooldownTurkish(a.CooldownMinutes),
        ...
        private static string GetCooldownTurkish(int cooldownMinutes)
        {
            return cooldownMinutes switch
            {
                1 => "1 dk",
                10 => "10 dk",
                30 => "30 dk",
                ...
                180 => "3 sa",
                1440 => "1 gün",
                _ when cooldownMinutes >= 60 => $"{cooldownMinutes / 60} sa",
                _ => $"{cooldownMinutes} dk"
            };
        }
