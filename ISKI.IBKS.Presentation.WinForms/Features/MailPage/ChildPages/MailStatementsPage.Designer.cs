...
namespace ISKI.IBKS.Presentation.WinForms.Features.MailPage.ChildPages
{
    partial class MailStatementsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            ColumnCooldown = new DataGridViewTextBoxColumn();
            ...
            DataGridViewAlarms.Columns.AddRange(new DataGridViewColumn[] { ColumnName, ColumnAlarmUsers, UsersColumn, ColumnDescription, ColumnType, ColumnCooldown, ColumnStatus, EditColumn, DeleteColumn });
            ...
            // ColumnCooldown
            ColumnCooldown.DataPropertyName = "Cooldown";
            ColumnCooldown.HeaderText = "Soğuma Süresi";
            ColumnCooldown.Name = "Cooldown";
            ColumnCooldown.ReadOnly = true;
            ColumnCooldown.FillWeight = 80F;
        ...
        private DataGridViewTextBoxColumn ColumnCooldown;
